            ...
            @permission('manage-users')
                <li class="{{ Active::pattern('admin/access/*') }}">
                    ...
                    <ul class="treeview-menu {{ Active::pattern('admin/access*', 'menu-open') }}" style="display: none; {{ Active::pattern('admin/access*', 'display: block;') }}">
                        <li class="{{ Active::pattern('admin/access') }}">
                            {{ link_to_route('admin.wechatuser', trans('menus.backend.access.title')) }}
                        </li>
                        <li class="{{ Active::pattern('admin/access/') }}">
                            {{ link_to_route('admin.wechatuser.active', trans('中奖列表')) }}
                        </li>
                    </ul>
                </li>
            @endauth
            <li class="{{ Active::pattern('admin/reward/*') }}">
                {{ link_to_route('admin.reward', trans('menus.backend.reward.title')) }}
            </li>

            <li class="{{ Active::pattern('admin/log/*') }}">
                {{ link_to_route('admin.log', trans('menus.backend.log.title')) }}
            </li>
